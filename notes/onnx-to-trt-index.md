...
| `plnet_s0.onnx` | `plnet_s0_fixed.engine` | 55MB | 50.6225 qps | `trtexec --onnx=plnet_s0.onnx --saveEngine=plnet_s0_fixed.engine --memPoolSize=workspace:4096 --verbose --shapes=input:1x1x512x512` |

## Conversion Environment

All conversions used:
- **TensorRT Version**: 8.6.1.6
- **LD_LIBRARY_PATH**: `./targets/x86_64-linux-gnu/lib:/usr/local/cuda/targets/x86_64-linux-gnu/lib:$LD_LIBRARY_PATH`
...
|-----------|---------|--------------|--------|---------|
| `plnet_s0.onnx` | Dynamic Shapes | `trtexec --onnx=plnet_s0.onnx --saveEngine=plnet_s0.engine --memPoolSize=workspace:512 --verbose` | ❌ Failed | Segmentation fault during engine serialization |
...
- **Total Models**: 6
- **Successful Conversions**: 6 (100% success rate)
- **Failed Attempts**: 1 (dynamic shapes for plnet_s0 failed)
- **Total Engine Size**: ~159MB
- **Performance Range**: 50-520 qps
- **Key Solution**: Fixed input shapes resolved segmentation faults for complex models
